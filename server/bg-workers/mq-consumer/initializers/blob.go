...
// ConnectMinIO initializes a MinIO client that connects to the internal endpoint
// but signs URLs for the public endpoint (so signatures work in the browser).
